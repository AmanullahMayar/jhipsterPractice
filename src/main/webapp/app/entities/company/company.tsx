  ...
  return (
    <div>
      <h2 id="company-heading" data-cy="CompanyHeading">
        <Translate contentKey="testprojectApp.company.home.title">Companies</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="testprojectApp.company.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/company/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="testprojectApp.company.home.createLabel">Create new Company</Translate>
          </Link>
        </div>
      </h2>
        ...
        {companyList && companyList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="testprojectApp.company.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('companyDescription')}>
                  <Translate contentKey="testprojectApp.company.companyDescription">Company Description</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('companyDescription')} />
                </th>
            ...
            <tbody>
              {companyList.map((company, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{company.createDate ? <TextFormat type="date" value={company.createDate} format={APP_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="testprojectApp.company.home.notFound">No Companies found</Translate>
            </div>
          )
        )}
      </div>
